...
public class ImageContent {
    public static final int[] beltImagesID = {
            ...
            R.drawable.factory_belt_4,
            R.drawable.factory_belt_5,
            R.drawable.factory_belt_6,
            R.drawable.factory_belt_7,
            R.drawable.factory_belt_8,
    ...
    public static final int[] robotImagesID = {
            ...
            R.drawable.factory_robot_4,
            R.drawable.factory_robot_5,
            R.drawable.factory_robot_6,
            R.drawable.factory_robot_7,
            R.drawable.factory_robot_8,
    ...
    public static final int[] ovenImagesID = {
            ...
            R.drawable.factory_oven_4,
            R.drawable.factory_oven_5,
            R.drawable.factory_oven_6,
            R.drawable.factory_oven_7,
