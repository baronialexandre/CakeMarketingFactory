...
public class Factory implements Serializable {
    ...
    private ArrayList<Integer> stocksActual;
    ...
    public void setStocks(ArrayList<Integer> stocks) { this.stocksActual = stocks; }
